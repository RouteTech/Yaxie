...
END;", table, id, seq));
    ...
    {
        public static string DefaultDirectory = "Yaxie.Migrations";
        public static string DefaultDB = DefaultDirectory + ".DefaultDB";
        public static int NameLength = 100;
        public static int AddressLength = 100;
        public static int CityLength = 30;
        public static int PostalCodeLength = 10;
        public static int ShortDescriptionLength = 50;
        public static int DescriptionLength = 255;
        public static int EmailLength = 255;
        public static int PathLength = 255;
        public static int WebSiteLength = 2000;
        public static int PhoneLength = 14;
