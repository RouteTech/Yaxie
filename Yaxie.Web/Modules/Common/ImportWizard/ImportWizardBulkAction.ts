...
namespace Yaxie.Common {
    ...
    export class ImportWizardBulkAction extends Common.BulkServiceAction {
        ...
        protected getBatchSize() {
          ...
          // the batch parameter contains the selected Account IDs 
          // that should be processed.
        
        protected executeForBatch(batch) {
            ImportWizardService.ImportWizardBulkAction(
                {
                    ImportWizardIdList : batch.map(x => Q.parseInteger(x))
                },
