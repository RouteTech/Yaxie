    ...
    declare namespace Db {
        ...
        namespace Common {
            ...
            namespace ImportSource {
                ...
                export const ImportSourceId: string;
            }

            namespace ImportType {
                export const Description: string;
                export const ImportTypeId: string;
            }

            namespace ImportWizard {
                export const ColumnErrorCount: string;
                export const Description: string;
                export const EndAtRow: string;
                export const FieldDelimiterId: string;
                export const FieldMatchDisplay: string;
                export const FieldMatchList: string;
                export const ImportFileList: string;
                export const ImportSourceId: string;
                export const ImportTypeDescription: string;
                export const ImportTypeId: string;
                export const ImportWizardId: string;
                export const KeyColumn: string;
                export const KeyType: string;
                export const LastRunDate: string;
                export const MatchOnFieldNames: string;
                export const MatchOnLabels: string;
                export const NoteList: string;
                export const RowErrorCount: string;
                export const SourceDirectory: string;
                export const StartAtRow: string;
                export const TargetDatabase: string;
            }

            namespace ImportWizardHistory {
                export const ErrorList: string;
                export const ImportWizardColumnErrorCount: string;
                export const ImportWizardDescription: string;
                export const ImportWizardEndAtRow: string;
                export const ImportWizardFieldDelimiterId: string;
                export const ImportWizardFieldMatchDisplay: string;
                export const ImportWizardFieldMatchList: string;
                export const ImportWizardHistoryId: string;
                export const ImportWizardId: string;
                export const ImportWizardImportFileList: string;
                export const ImportWizardImportSourceId: string;
                export const ImportWizardImportTypeId: string;
                export const ImportWizardKeyColumn: string;
                export const ImportWizardKeyType: string;
                export const ImportWizardLastRunDate: string;
                export const ImportWizardMatchOnFieldNames: string;
                export const ImportWizardMatchOnLabels: string;
                export const ImportWizardNoteId: string;
                export const ImportWizardRowErrorCount: string;
                export const ImportWizardSourceDirectory: string;
                export const ImportWizardStartAtRow: string;
                export const ImportWizardTargetDatabase: string;
                export const OriginalFileName: string;
                export const Results: string;
                export const RowsInserted: string;
                export const RowsUpdated: string;
                export const RunDateTime: string;
                export const TempFileName: string;
            }
        ...
        namespace NorthWind {
            ...
            namespace EmployeeTerritories {
                ...
                export const TerritoryId1: string;
            ...
            namespace Invoices {
                ...
                export const ShipperName: string;
            ...
            namespace OrderDetails {
                ...
                export const OrderFreight: string;
                export const OrderId: string;
                export const OrderOrderDate: string;
                export const OrderRequiredDate: string;
                export const OrderShipAddress: string;
                export const OrderShipCity: string;
                export const OrderShipCountry: string;
                export const OrderShipName: string;
                export const OrderShipPostalCode: string;
                export const OrderShipRegion: string;
            ...
            namespace Orders {
                ...
                export const CustomerId: string;
                export const CustomerId1: string;
            ...
            namespace Territories {
                export const Id: string;
                export const RegionId: string;
                export const RegionRegionDescription: string;
